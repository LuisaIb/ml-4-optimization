...
# Model training
vae %>% fit(
  input_data_scaled, input_data_scaled,  # Use your custom input data and target values
  #shuffle = TRUE, 
  epochs = epochs, 
  batch_size = batch_size,
  validation_data = list(test_data_scaled, test_data_scaled)
)
...
x_test_encoded <- predict(encoder, input_data_scaled, batch_size = batch_size)
x_test_decoded <- predict(generator, x_test_encoded, batch_size = batch_size)


#x_test_decoded
x_test_decoded_descaled <- descaleData(x_test_decoded, scaled$min, scaled$max)

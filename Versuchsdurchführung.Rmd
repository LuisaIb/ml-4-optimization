...
Versuch 2.1.2.1 f1 + 600 Datenpunkte + 3 dim + Random Sampling + (4, 10*dim, 20*dim)
Versuch 2.1.2.2 f1 + 600 Datenpunkte + 3 dim + Grid Sampling + (4, 10*dim, 20*dim)
Versuch 2.1.2.3 f1 + 600 Datenpunkte + 3 dim + LHS + (4, 10*dim, 20*dim)
...
Versuch 2.2.2.1 f4 + 600 Datenpunkte + 3 dim + Random Sampling + (4, 10*dim, 20*dim)
Versuch 2.2.2.2 f4 + 600 Datenpunkte + 3 dim + Grid Sampling + (4, 10*dim, 20*dim)
Versuch 2.2.2.3 f4 + 600 Datenpunkte + 3 dim + LHS + (4, 10*dim, 20*dim)
...
## Versuch 2.1.1.1
- kein überragendes Ergebnis, Optimum wird nicht gefunden, RNN ist unbrauchbar, höher Datenpunktanzahl verbessert das Ergebnis
...
|-> Versuch 2.1.1 : Random Sampling am besten, Grid Sampling am schlechtesten, Ergebnisse schlecht, RNN ist unbrauchbar
|-> Versuch 2.2.1 : Random Sampling am besten, Grid Sampling am schlechtesten, Ergebnisse schlecht, RNN ist unbrauchbar

...
model_rnn_random <- createRNNModel(epochs = 150, X_train, y_train, X_test, y_test)
...
## plot results
print(plotBenchmarkPerformance(list(resnnde, resesde),
                    c("nnreg","gaussestimation")))

## plot results
print(plotBenchmarkPerformance(list(resnnde,resgtde),
                    c("nnreg","groundtruth")))
...
resgtde2 <- loggedExperiment(exprDE2, groundtruth, 1:10,10)
resgtde2
...
# from the estimation of cobbs result
resesde2 <- loggedExperiment(exprDE2, cobbsResult$estimation, 1:10,10)
resesde2
...
# from the rnn  result
resnnde2 <- loggedExperiment(exprDE2, model_rnn_random$predict, 1:10,10)
resnnde2
...
## plot results
print(plotBenchmarkPerformance(list(resesde2,resnnde2,resgtde2),
                    c("gaussestimation","nnreg","groundtruth")))


## plot results
print(plotBenchmarkPerformance(list(resnnde2, resesde2),
                    c("nnreg","gaussestimation")))

## plot results
print(plotBenchmarkPerformance(list(resnnde2,resgtde2),
                    c("nnreg","groundtruth")))


## plot error, comparing against groundtruth
print(plotBenchmarkValidation(resgt,list(resesde2,resnnde2),
                    c("gaussestimation","nnreg")))
...
resgtde3 <- loggedExperiment(exprDE3, groundtruth, 1:10,10)
resgtde3
...
# from the estimation of cobbs result
resesde3 <- loggedExperiment(exprDE3, cobbsResult$estimation, 1:10,10)
resesde3
...
# from the rnn  result
resnnde3 <- loggedExperiment(exprDE3, model_rnn_random$predict, 1:10,10)
resnnde3
...
## plot results
print(plotBenchmarkPerformance(list(resesde3,resnnde3,resgtde3),
                    c("gaussestimation","nnreg","groundtruth")))


## plot results
print(plotBenchmarkPerformance(list(resnnde3, resesde3),
                    c("nnreg","gaussestimation")))

## plot results
print(plotBenchmarkPerformance(list(resnnde3,resgtde3),
                    c("nnreg","groundtruth")))


## plot error, comparing against groundtruth
print(plotBenchmarkValidation(resgtde3,list(resesde3,resnnde3),
                    c("gaussestimation","nnreg")))

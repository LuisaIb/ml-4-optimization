...
#z <- seq(from=lower[2],to=upper[2],length.out=numImages)
z <- c(0,lower[2])
...
for(num in z){
  ...
  fp <- file.path("images/F24_3D/", paste0(11, ".png"))
...
imgs <- list.files("images/F24_3D", full.names = TRUE)

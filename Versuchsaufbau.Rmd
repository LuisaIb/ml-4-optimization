...
- Das Training wird für eine bestimmte Anzahl von Epochen (epochs) und in Batches (batch_size) durchgeführt. - Das Modell wird auch mit den Testdaten (test_data) validiert, um die Modellleistung zu überwachen.
...
Modelldefinition: 
- Das DNN besteht aus mehreren Dense-Layern, die in einer sequenziellen Reihenfolge definiert sind. 
...
### Optimierfunktion 1 - Differential Evolution | Population size: dimensionen * 20


### Optimierfunktion 1.1 - Differential Evolution | Population size: 2-3



### Optimierfunktion 2 - L-BFGS-B

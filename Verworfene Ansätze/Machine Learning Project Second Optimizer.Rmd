...
BFGSinterface <-function(x=NULL,fun,lower,upper,control=list(),...){
  ...
  control$abstol <- 1e-99999999999999999999999999999999999999999999999999999999
  control$reltol <- 1e-99999999999999999999999999999999999999999999999999999999
  
  
  control$maxit <- 200
  control$pgtol <- 1e-99999999999999999999999999999999999999999999999999999999
  control$factr <- 1e-99999999999999999999999999999999999999999999999999999999
  control$lmm <- 200

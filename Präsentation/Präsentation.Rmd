...
<x>
![Alt-Text](images/Experiment1.png)
...
<x>
![Alt-Text](images/Experiment2.png)


## Übersicht Experimente und Versuche - 3. Experiment

<x>
![Alt-Text](images/Experiment3.png)
...
<x>
![Alt-Text](images/ExperimentBest.png)
...
##
<x>
![Alt-Text](images/Experiment1Result.png)

##
<x>
![Alt-Text](images/Experiment3Result.png)

## Ist der Einsatz von RNN geeignet?

... Versuchsbewertung mit den 6 Kriterien
-  [...|5] Difficulty (Mehrdimensionalität 2+3)
-  [...|5] Diversity ()
-  [...|5] Flexibility ()
-  [...|5] Relevance ()
-  [...|5] Evaluation cost ()
-  [1|5] Non-Smoothing (nein, 2 RNNs hintereinander verworfen, Simulaton nicht erstellt)

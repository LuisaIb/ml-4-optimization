...
## 
- durchschnittlicher Trainingsloss (0,1)
...
- (Visual) Loss Function Verlauf (0,3)
...
- (Visual) Generated Funciton vs. Original Function (0,4)
...
##
Diese wissenschaftlich ausgerichtete Bewertungsmatrix erlaubt eine systematische Analyse und Bewertung von Experimenten im Rahmen der Modell- und Optimierungsbewertung. Die gewählten Bewertungskriterien ermöglichen eine fundierte Beurteilung der Leistung von Modellen, Optimierungsalgorithmen und Versuchen, wobei sowohl qualitative als auch quantitative Aspekte berücksichtigt werden. Hierbei wird eine Gewichtung gesetzt Modell (0,3) Optimierung (0,7) um den Versuch zu bewerten.
...
## Simulation-based Test Function for Optimization Algorithms
- 6 Kriterien

...
+----------------+-------------------------------+----------------+
| E              | layer_dense(units=128,        | Leaky ReLU     |
| ingangsschicht | input_shape=2)                |                |
+----------------+-------------------------------+----------------+
| Ver            | layer_dense(units=32)         | Leaky ReLU     |
| b              |                               |                |
| orgene-Schicht |                               |                |
+----------------+-------------------------------+----------------+
| Ver            | layer_dense(units=128)        | Leaky ReLU     |
| b              |                               |                |
| orgene-Schicht |                               |                |
+----------------+-------------------------------+----------------+
| D              | layer_dropout(rate=0.001)     | \-             |
| ropout-Schicht |                               |                |
+----------------+-------------------------------+----------------+
| Ver            | layer_dense(units=64)         | Leaky ReLU     |
| b              |                               |                |
| orgene-Schicht |                               |                |
+----------------+-------------------------------+----------------+
| A              | layer_dense(units=1)          | Linear         |
| usgangsschicht |                               | Activation     |
+----------------+-------------------------------+----------------+

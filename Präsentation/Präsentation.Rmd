...
+--------------------------------------------------------------------------+----------------------------------------------+
| -   Groundtruth (GT) und Gaußsche Prozessmodelle (GPM): gute Optimierung | -   **GT und GPM: im Median gut**            |
|                                                                          |                                              |
| -   DNN: mehr Evaluationen                                               | -   **DNN: Optimierung deutlich schlechter** |
+--------------------------------------------------------------------------+----------------------------------------------+
...
| Population Size = 4                                                   | **Population Size = 10 \* Dimension**                             |
+-----------------------------------------------------------------------+-------------------------------------------------------------------+
| -   GT und GPM: Fehler von Anfang an sehr niedrig                     | -   **GT und GPM: Fehler von Anfang an sehr niedrig**             |
|                                                                       |                                                                   |
| -   DNN: Fehler am Anfang sehr hoch, jedoch zuverlässige Verringerung | -   **DNN: selbst nach 200 Evaluationen noch schlechter als GPM** |
+-----------------------------------------------------------------------+-------------------------------------------------------------------+
...
+------------------------------------------------------------------------------+----------------------------------------------------------+
| -   GT und GP: Minimum nach 400 Evalutationen nicht gefunden                 | -   **GT: Minimum nach 400 Evaluationen nicht gefunden** |
|                                                                              |                                                          |
| -   DNN: im Median in Ordnung, aber Durchläufe in denen nicht optimiert wird | -   **GPM und DNN: ähnlich gut**                         |
+------------------------------------------------------------------------------+----------------------------------------------------------+
...
| 2 Dimensionen                                 | **3 Dimensionen**                            |
+-----------------------------------------------+----------------------------------------------+
| -   GPM: in manchen Durchläufen teils nache 0 | -   **GPM und DNN: deutlich höherer Fehler** |
|                                               |                                              |
